<?php
    ...
    /**
     * The portlet view for animals detail view
     */
    class AnimalDetailsPortletView extends AnimalEditAndDetailsView implements PortletViewInterface
    {
        protected $params;
        protected $viewData;
        ...
        {
            return 'AnimalEditAndDetailsView';
        }
