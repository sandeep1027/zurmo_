<?php
    ...
    /**
     * Tests on animals specific search permutations.
     */
    class AnimalsSearchWithDataProviderTest extends ZurmoBaseTest
    {
        ...
        public function testSearchByCustomField()
        {
            ...
            //todo: add animals. 2 of them.
            AnimalTestHelper::createAnimalByNameForOwner('aFirstAnimal', $super);
            AnimalTestHelper::createAnimalByNameForOwner('aSecondAnimal', $super);
            ...
            //Run search and make sure the data returned matches how many total animals are available.
            $dataProvider        = new RedBeanModelDataProvider('Animal', null, false, $searchAttributeData);
